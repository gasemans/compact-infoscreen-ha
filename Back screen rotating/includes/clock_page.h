...
//
// Nagebouwd naar het klassieke NS/SBB-stationsklok ontwerp, maar met
// zwarte achtergrond (passend bij de rest van de app):
// - zwarte wijzerplaat
// - dikke witte uurstrepen (12x), dunnere minuutstrepen (48x)
// - witte, getaperde uur- en minutenwijzer
